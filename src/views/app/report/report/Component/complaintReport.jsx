    ...
    <div>
      <div className="container text-primary font-weight-bold py-2 bg-warning mt-2">
        ...
        >
          ...
          <div
            className={
              sections.includes("ComRep") ? "dropup btn-group m-0 p-0" : ""
            }
          >
            <Button
              style={{ height: "20px" }}
              color="primary"
              className={`m-0 p-0 ${sections.includes("ComRep") ? "mt-n1" : "mt-n3"}  dropdown-toggle-split dropdown-toggle btn table-expand`}
            ></Button>
          </div>
        </h4>
      </div>
