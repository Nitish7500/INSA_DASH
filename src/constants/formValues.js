...
export const occupation = [
    ...
    { value: 'Army Personnel', label: 'Army Personnel' },
...
export const ombudsmanLocation = [
    ...
    { value: '0: Ahmedabad', label: 'Ahmedabad' },
    { value: '1: Bengaluru', label: 'Bengaluru' },
    { value: '2: Bhopal', label: 'Bhopal' },
    { value: '3: Bhubaneshwar', label: 'Bhubaneshwar' },
    { value: '4: Chandigarh', label: 'Chandigarh' },
    { value: '5: Chennai', label: 'Chennai' },
    { value: '6: Delhi', label: 'Delhi' },
    { value: '7: Guwahati', label: 'Guwahati' },
    { value: '8: Hyderabad', label: 'Hyderabad' },
    { value: '9: Jaipur', label: 'Jaipur' },
    { value: '10: Ernakulam', label: 'Ernakulam' },
    { value: '11: Kolkata', label: 'Kolkata' },
    { value: '12: Lucknow', label: 'Lucknow' },
    { value: '13: Mumbai', label: 'Mumbai' },
    { value: '14: Noida', label: 'Noida' },
    { value: '15: Patna', label: 'Patna' },
    { value: '16: Pune', label: 'Pune' },
